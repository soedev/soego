...
import (
	...
	// 引入file的config协议
	_ "github.com/soedev/soego/core/econf/file"
	"github.com/soedev/soego/core/eflag"
	"github.com/soedev/soego/core/elog"
	"github.com/soedev/soego/core/eregistry"
	"github.com/soedev/soego/core/util/xcycle"
...
// Invoker 传入所需要的函数
func (e *SoEgo) Invoker(fns ...func() error) *SoEgo {
	e.smu.Lock()
	defer e.smu.Unlock()
...
// Registry 设置注册中心
func (e *SoEgo) Registry(reg eregistry.Registry) *SoEgo {
	e.registerer = reg
	return e
}

// Serve 设置服务
func (e *SoEgo) Serve(s ...server.Server) *SoEgo {
	e.smu.Lock()
	defer e.smu.Unlock()
...
// Cron 设置定时任务
func (e *SoEgo) Cron(w ...ecron.Ecron) *SoEgo {
	e.crons = append(e.crons, w...)
	return e
}

// Job 设置短时任务
func (e *SoEgo) Job(runners ...ejob.Ejob) *SoEgo {
	// start job by name
...
// Stop 停止程序
func (e *SoEgo) Stop(ctx context.Context, isGraceful bool) (err error) {
	// 运行停止前清理
