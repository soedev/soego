...
func fileWithLineNum() string {
	...
	for i := 2; i < 20; i++ {
		...
		if (!(strings.Contains(file, "soego") && strings.HasSuffix(file, "client/ehttp/interceptor.go")) && !strings.Contains(file, "go-resty/resty")) || strings.HasSuffix(file, "_test.go") {
