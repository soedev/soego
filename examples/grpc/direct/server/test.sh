...
protoc --proto_path=${ROOT}/examples/helloworld  --go-test_out=mod=github.com/soedev/soego/examples/helloworld,out=./server,paths=source_relative:. helloworld.proto
