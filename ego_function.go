...
import (
	...
	"github.com/soedev/soego/core/esentinel"
...
func (e *SoEgo) startServers(ctx context.Context) error {
	// start multi servers
...
func (e *SoEgo) initSentinel() error {
...
// printBanner init
func (e *SoEgo) printBanner() error {
